...
import { Loader2, Warehouse, Mail, Lock } from "lucide-react"
    ...
    <div className={cn("flex flex-col items-center gap-6", className)}>
      ...
      <div className="flex flex-col items-center gap-3 animate-fade-in-down">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold tracking-tight">Almox IA</h1>
          <p className="text-sm text-muted-foreground">Sistema de Almoxarifado Inteligente</p>
        </div>
      </div>
      ...
      <p className="text-xs text-muted-foreground animate-fade-in">
        Almox IA &copy; {new Date().getFullYear()}
      </p>
    </div>
  )
}
